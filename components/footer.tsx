      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 lg:px-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-8">
          ...
          <div className="col-span-2 md:col-span-1 mb-4 md:mb-0">
            <h3 className="text-lg md:text-xl mb-2 md:mb-4 uppercase" style={{ fontFamily: "'Clash Display', system-ui, sans-serif", fontWeight: 700, letterSpacing: "0.65px", lineHeight: 1.05 }}>JON SPIRIT</h3>
